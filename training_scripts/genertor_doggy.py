...
def generator(instance_data_dir, output_dir):
    ...
    for i in trange(1000, desc = "generating images"):
        ...
        image = pipe(prompts[2], num_inference_steps=50, guidance_scale=7).images[0]
        image_save_path = os.path.join(output_dir, 'seed_images', "image1_seed{}.jpg".format(i+1))
        image.save(image_save_path)
...
instance_data_dir = "/home/nmathur/dataset/tune_diffusion/doggy"
output_dir = '/home/nmathur/output_lora_ram/doggy/lora_8_0.0001_5e-05_1000_False'
generator(instance_data_dir, output_dir)

output_dir = "/home/nmathur/output_lora_ram/doggy/lora_8_0.0001_0.0001_1000_False"
generator(instance_data_dir, output_dir)
