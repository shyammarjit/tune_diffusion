...
def evaluator(args, prompts):
    ...
    clipt = CLIP_T(gen_folder_path = args.output_dir, prompts = prompts)
    return clipi, clipt
...
def save_metrics(args, clipi, clipt):
    ...
    exp_name = f'{args.output_dir}/log{args.diffusion_model}_{args.lora_or_krona}_{args.lora_rank}_{args.num_train_epochs}_{number_of_input_img}_{args.learning_rate}_{args.with_prior_preservation}.json'
    print(exp_name)
