...
def save_metrics(args, clipi, clipt):
    ...
    exp_info = {"Dataset_Name": os.path.basename(args.instance_data_dir), 
        ...
        "attention_update":args.attn_update,
    ...
    exp_name = f'{args.output_dir}/log_{args.attn_update}_{args.diffusion_model}_{args.adapter_type}_{args.lora_rank}_{args.max_train_steps}_{number_of_input_img}_{args.learning_rate}_{args.with_prior_preservation}.json'
    print(exp_name)
