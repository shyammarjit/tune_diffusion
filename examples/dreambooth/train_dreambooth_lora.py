...
def main(args):
    ...
    for name, attn_processor in unet.attn_processors.items():
        ...
        module = lora_attn_processor_class(
            hidden_size=hidden_size, cross_attention_dim=cross_attention_dim, rank=args.lora_rank, adapter_type=args.adapter_type
        )
    ...
    if accelerator.is_main_process:
        ...
        pipeline.load_lora_weights(args.output_dir, weight_name="pytorch_lora_weights.bin", adapter_type=args.adapter_type)
