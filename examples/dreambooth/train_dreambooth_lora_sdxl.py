...
def struct_output(args):
    ...
    if(args.adapter_type=="krona"): exp = f"krona_{args.attn_update}_{args.diffusion_model}_{args.lora_rank}_{args.learning_rate}_{args.max_train_steps}_{args.with_prior_preservation}"
    elif(args.adapter_type=="lora"): exp = f"lora_{args.attn_update}_{args.diffusion_model}_{args.lora_rank}_{args.learning_rate}_{args.max_train_steps}_{args.with_prior_preservation}"
    elif(args.adapter_type=="pa"): exp = f"pa_{args.attn_update}_{args.diffusion_model}_{args.lora_rank}_{args.learning_rate}_{args.max_train_steps}_{args.with_prior_preservation}"
    elif(args.adapter_type=="glora") : exp = f"glora_{args.attn_update}_{args.diffusion_model}_{args.lora_rank}_{args.learning_rate}_{args.max_train_steps}_{args.with_prior_preservation}"
