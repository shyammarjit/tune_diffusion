...
def struct_output(args):
    ...
    if(args.lora_or_krona==1): exp = f"krona_{args.diffusion_model}_{args.lora_rank}_{args.learning_rate}_{args.max_train_steps}_{args.with_prior_preservation}"
    elif(args.lora_or_krona==0): exp = f"lora_{args.diffusion_model}_{args.lora_rank}_{args.learning_rate}_{args.max_train_steps}_{args.with_prior_preservation}"
...
def parse_args(input_args=None):
    ...
    parser.add_argument(
        ...
        type=int,
        default=0,
        help="pass choices as arguments 0 for lora 1, for krona",
        choices=[0,1],
    )
...
def main(args):
    ...
    for name, attn_processor in unet.attn_processors.items():
        ...
        module = lora_attn_processor_class(hidden_size=hidden_size, cross_attention_dim=cross_attention_dim, rank=args.lora_rank)
